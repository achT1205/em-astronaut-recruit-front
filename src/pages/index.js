        ...
        <section className="hero-banner">
          <div className="container">
            <article className="inner-content">
              <h2 className="maintitle">THE RECRUITS  tableName: {process.env.PLAYER_TABLE}, Chaine infos: {process.env.NEXT_PUBLIC_CHAIN_ID}-{process.env.NEXT_PUBLIC_CHAIN_NAME}, </h2>
